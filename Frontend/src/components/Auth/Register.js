                        ...
                        <div className="columns is-centered">
                            <div className="column is-4-desktop">
                                <form onSubmit={Register} className="box">
                                    ...
                                    <h1 className='columns is-centered mt-2'>ĐĂNG KÝ</h1>
                                    ...
                                    <div className="field mt-5">
                                        <button className="button is-success is-fullwidth">Đăng ký</button>
                                    </div>
                                    <div className="has-text-centered mt-4">
                                        <p>Bạn đã có tài khoản? <a href="/login" className="has-text-link">Đăng nhập</a></p>
                                    </div>
                                </form>
                            </div>
                        </div>
